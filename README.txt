...
Si se desea obtener un archivo de vectores energéticos (consumos y producción) para su proceso con **epbdcalc** o **epbdpanel** puede aplicarse la medida CTE_EPBDcalc como medida de informe.
