  ...
  default_construction_sets.each do |default_construction_set|
    if default_construction_set.directUseCount > 0
      ...
      if !default_surface_const_set.empty?
        ...
        new_default_construction_set.setName("#{default_construction_set.name} adj ext floor insulation")
        ...
        new_default_surface_const_set.setName("#{default_surface_const_set.get.name} adj ext floor insulation")
